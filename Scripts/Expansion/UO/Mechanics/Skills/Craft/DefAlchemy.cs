...
namespace Server.Engines.Craft
{
    ...
    public class DefAlchemy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.TOL)
            {
                index = AddCraft(typeof(BarrabHemolymphConcentrate), 1116348, 1156724, 51.0, 151.0, typeof(EmptyBottle), 1044529, 1, 500315);
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(InvisibilityPotion), 1116349, 1074860, 65.0, 115.0, typeof(EmptyBottle), 1044529, 1, 500315);
            ...
            if (Core.TOL)
            {
                ...
                index = AddCraft(typeof(KurakAmbushersEssence), 1116349, 1156728, 51.0, 151.0, typeof(EmptyBottle), 1044529, 1, 500315);
                ...
                index = AddCraft(typeof(BarakoDraftOfMight), 1116349, 1156729, 51.0, 151.0, typeof(EmptyBottle), 1044529, 1, 500315);
                ...
                index = AddCraft(typeof(UraliTranceTonic), 1116349, 1156734, 51.0, 151.0, typeof(EmptyBottle), 1044529, 1, 500315);
                ...
                index = AddCraft(typeof(SakkhraProphylaxisPotion), 1116349, 1156732, 51.0, 151.0, typeof(EmptyBottle), 1044529, 1, 500315);
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(ParasiticPotion), 1116350, 1072942, 65.0, 115.0, typeof(EmptyBottle), 1044529, 1, 500315);
                AddRes(index, typeof(ParasiticPlant), 1073474, 5, 1044253);
                AddRecipe(index, (int)TinkerRecipes.ParasiticPotion);

                index = AddCraft(typeof(DarkglowPotion), 1116350, 1072943, 65.0, 115.0, typeof(EmptyBottle), 1044529, 1, 500315);
            ...
            if (Core.ML)
            {
                index = AddCraft(typeof(ConflagrationPotion), 1116351, 1072096, 55.0, 105.0, typeof(EmptyBottle), 1044529, 1, 500315);
                AddRes(index, typeof(GraveDust), 1023983, 5, 1044253);

                index = AddCraft(typeof(GreaterConflagrationPotion), 1116351, 1072099, 70.0, 120.0, typeof(EmptyBottle), 1044529, 1, 500315);
                AddRes(index, typeof(GraveDust), 1023983, 10, 1044253);

                index = AddCraft(typeof(ConfusionBlastPotion), 1116351, 1072106, 55.0, 105.0, typeof(EmptyBottle), 1044529, 1, 500315);
                AddRes(index, typeof(PigIron), 1023978, 5, 1044253);

                index = AddCraft(typeof(GreaterConfusionBlastPotion), 1116351, 1072109, 70.0, 120.0, typeof(EmptyBottle), 1044529, 1, 500315);
