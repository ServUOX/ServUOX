...
namespace Server.Items
{
    ...
    public class AnkhWest : Item
    {
            ...
            : base(bloodied ? 0x1D98 : 0x3)
        {
            ...
            m_Item = new AnkhWestItem(bloodied, this);
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            m_Item = reader.ReadItem() as AnkhWestItem;
        }

        private class AnkhWestItem : Item
        {
            private AnkhWest m_Item;
            public AnkhWestItem(bool bloodied, AnkhWest item)
            ...
            public AnkhWestItem(Serial serial)
                : base(serial)
            {
            }
    ...
    public class AnkhNorth : Item
    {
            ...
            : base(bloodied ? 0x1E5D : 0x4)
        {
            ...
            m_Item = new AnkhNorthItem(bloodied, this);
        }
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            m_Item = reader.ReadItem() as AnkhNorthItem;
        }

        [TypeAlias("Server.Items.AnkhEast+InternalItem")]
        private class AnkhNorthItem : Item
        {
            private AnkhNorth m_Item;
            public AnkhNorthItem(bool bloodied, AnkhNorth item)
            ...
            public AnkhNorthItem(Serial serial)
                : base(serial)
            {
            }
