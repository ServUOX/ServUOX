...
namespace Server.Items
{
    ...
    public class BroadcastCrystal : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.Target = new BroadcastCrystalTarget(this);
        }
        ...
        private class BroadcastCrystalTarget : Target
        {
            private readonly BroadcastCrystal m_Crystal;
            public BroadcastCrystalTarget(BroadcastCrystal crystal)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is ReceiverCrystal receivertarg)
                {
    ...
    public class ReceiverCrystal : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.Target = new ReceiverCrystalTarget(this);
        }
        ...
        private class ReceiverCrystalTarget : Target
        {
            private readonly ReceiverCrystal m_Crystal;
            public ReceiverCrystalTarget(ReceiverCrystal crystal)
