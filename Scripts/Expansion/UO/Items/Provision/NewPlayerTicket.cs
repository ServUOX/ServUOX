    ...
    public class NewPlayerTicket : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                ...
                from.Target = new NewPlayerTicketTarget(this);
            }
        }

        private class NewPlayerTicketTarget : Target
        {
            private readonly NewPlayerTicket m_Ticket;
            public NewPlayerTicketTarget(NewPlayerTicket ticket)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                else if (targeted is NewPlayerTicket)
                {
                    ...
                    {
                        from.SendGump(new NewPlayerTicketGump(from, m_Ticket));
                        them.SendGump(new NewPlayerTicketGump(them, theirTicket));
                    }
                }
        ...
        private class NewPlayerTicketGump : Gump
        {
            private readonly Mobile m_From;
            private readonly NewPlayerTicket m_Ticket;
            public NewPlayerTicketGump(Mobile from, NewPlayerTicket ticket)
                : base(50, 50)
            {
                m_From = from;
                m_Ticket = ticket;
