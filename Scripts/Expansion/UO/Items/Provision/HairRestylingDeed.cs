...
namespace Server.Items
{
    public class HairRestylingDeed : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.SendGump(new HairRestylingDeedGump(from, this));
            }
        }

        private class HairRestylingDeedGump : Gump
        {
            ...
            */
            ...
            public HairRestylingDeedGump(Mobile from, HairRestylingDeed deed)
                : base(50, 50)
            {
                m_From = from;
                m_Deed = deed;

                from.CloseGump(typeof(HairRestylingDeedGump));
