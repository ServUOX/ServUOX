...
namespace Server.Items
{
    ...
    public class PottedCactusDeed : Item, IRewardItem
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.CloseGump(typeof(PottedCactusDeedGump));
                from.SendGump(new PottedCactusDeedGump(this));
            }
            else
            {
        ...
        private class PottedCactusDeedGump : Gump
        {
            private readonly PottedCactusDeed m_Cactus;
            public PottedCactusDeedGump(PottedCactusDeed cactus)
                : base(100, 200)
            {
                m_Cactus = cactus;
