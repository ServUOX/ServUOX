namespace Server.Mobiles
{
    public class CorruptedSoul : BaseCreature
    {
            ...
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, .1, 5)
        {
            ...
            SetDamage(ResistType.Phys, 100, 0, 4, 40);

            SetResist(ResistType.Phys, 61, 74);
            SetResist(ResistType.Fire, 22, 48);
            SetResist(ResistType.Cold, 73, 100);
            SetResist(ResistType.Pois, 0);
            SetResist(ResistType.Engy, 51, 60);
        ...
        public override bool BleedImmunity => true;// NEED TO VERIFY
