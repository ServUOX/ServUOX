...
namespace Server.Mobiles
{
    ...
    public class Lurg : Troglodyte
    {
        ...
        public Lurg()
        {
            ...
            SetDamage(ResistType.Phys, 100, 0, 16, 19);

            SetResist(ResistType.Phys, 50, 53);
            SetResist(ResistType.Fire, 45, 47);
            SetResist(ResistType.Cold, 56, 60);
            SetResist(ResistType.Pois, 50, 60);
            SetResist(ResistType.Engy, 41, 56);
