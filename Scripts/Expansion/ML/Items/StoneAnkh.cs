...
namespace Server.Items
{
    ...
    public class StoneAnkhDeed : BaseAddonDeed, IRewardItem
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                from.CloseGump(typeof(StoneAnkhDeedGump));
                from.SendGump(new StoneAnkhDeedGump(this));
            }
            else
            {
        ...
        private class StoneAnkhDeedGump : Gump
        {
            private readonly StoneAnkhDeed m_Deed;
            public StoneAnkhDeedGump(StoneAnkhDeed deed)
                : base(150, 50)
            {
                m_Deed = deed;
