...
namespace Server.Engines.Quests
{
    public class MadScientistQuest
    {
        ...
        public class QuestContext
        {
            ...
            public int IngredientsLeft { get; private set; } = NeededIngredients;
            public SutekIngredient CurrentIngredient { get; private set; }
            public Timer ExpireTimer { get; private set; }
            public ClockworkMechanism Mechanism { get; }
