...
namespace Server.Mobiles
{
    ...
    public class FairyDragon : BaseCreature
    {
            ...
            : base(AIType.AI_Mystic, FightMode.Closest, 10, 1, 0.2, 0.4)
        {
            ...
            SetDamageType(ResistType.Fire, 20, 25);
            SetDamageType(ResistType.Cold, 20, 25);
            SetDamageType(ResistType.Pois, 20, 25);
            SetDamageType(ResistType.Engy, 20, 25);

            SetResist(ResistType.Phys, 16, 30);
            SetResist(ResistType.Fire, 41, 44);
            SetResist(ResistType.Cold, 40, 49);
            SetResist(ResistType.Pois, 40, 49);
            SetResist(ResistType.Engy, 45, 47);
