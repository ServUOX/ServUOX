...
namespace Server.Items
{
    ...
    public class ConfirmRemoveGump : Gump
    {
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (index)
            {
                case 0: { m_Addon.User = null; break; } // { m_Addon.Using = false; break; }
                case 1:
                    {
    ...
    public class RepairBenchGump : Gump
    {
        ...
        private class RepairBenchAddonTarget : Target
        {
            private RepairBenchAddon m_Addon;
            private RepairBenchGump m_Gump;

            public RepairBenchAddonTarget(Mobile from, RepairBenchGump g, RepairBenchAddon addon)
            ...
            protected override void OnTarget(Mobile from, object targeted)
            {
                ...
                if (targeted is RepairDeed)
                {
                    ...
                    if (m_Addon.Tools.Any(x => x.Skill == deed.RepairSkill && x.Charges >= 500))
                    {
                        ...
                        from.Target = new RepairBenchAddonTarget(from, m_Gump, m_Addon);
                    }
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            else if (index == 1)
            {
                ...
                from.Target = new RepairBenchAddonTarget(from, this, m_Addon);
            }
