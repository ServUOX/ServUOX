...
namespace Server.Items
{
    public class MysticalPolymorphTotem : Item
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)]
        public int CostumeBody { get; set; } = 0;
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            else
            {
                if (CostumeBody == 0)
                {
                    ...
                    from.Target = new MysticalPolymorphTotemTarget(this);
                }
                else
                {
                    if (!Transformed)
        ...
        private class MysticalPolymorphTotemTarget : Target
        {
            private readonly MysticalPolymorphTotem m_Totem;

            public MysticalPolymorphTotemTarget(MysticalPolymorphTotem totem)
