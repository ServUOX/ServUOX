...
namespace Server.Items
{
    public class PetWhistle : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            {
                if (!(from.Account is Account acct) || acct.Username != Account)
                {
            ...
            if (IsChildOf(from.Backpack))
            {
                ...
                else
                {
                    ...
                    from.Target = new PetWhistleTarget(this);
                }
            }
            else
            {
        ...
        private class LinkBondedPetEntry : ContextMenuEntry
        {
            ...
            public override void OnClick()
            {
                ...
                if (_Item.IsChildOf(m_From.Backpack))
                {
                    ...
                    m_From.Target = new PetWhistleTarget(_Item);
                }
                else
                {
        ...
        private class PetWhistleTarget : Target
        {
            private readonly PetWhistle _Item;

            public PetWhistleTarget(PetWhistle item)
