...
namespace Server.Items
{
    public class StableSlotIncreaseToken : Item, IAccountRestricted, IPromotionalToken
    {
        ...
        public Type GumpType => typeof(StableSlotIncreaseToken.StableSlotIncreaseTokenGump);
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            {
                if (!(m.Account is Account acct) || acct.Username != Account)
                {
                ...
                m.CloseGump(typeof(StableSlotIncreaseTokenGump));
                m.SendGump(new StableSlotIncreaseTokenGump(this));
            }
        }
        ...
        private class StableSlotIncreaseTokenGump : Gump
        {
            private StableSlotIncreaseToken m_Token;

            public StableSlotIncreaseTokenGump(StableSlotIncreaseToken token)
                : base(10, 10)
            {
                m_Token = token;
