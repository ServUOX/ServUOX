...
namespace Server.Items
{
    public class MythicCharacterToken : Item, IPromotionalToken
    {
        ...
        public Type GumpType => typeof(MythicCharacterTokenGump);
        ...
        public override void OnDoubleClick(Mobile m)
        {
            if (m is PlayerMobile && IsChildOf(m.Backpack))
            {
                ...
                {
                    BaseGump.SendGump(new MythicCharacterTokenGump((PlayerMobile)m, this));
                }
            }
        }
        ...
        public class MythicCharacterTokenGump : BaseGump
        {
            ...
            public MythicCharacterTokenGump(PlayerMobile pm, MythicCharacterToken token)
                : base(pm, 100, 100)
            {
                Token = token;
