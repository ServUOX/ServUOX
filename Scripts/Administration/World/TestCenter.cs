...
namespace Server.Misc
{
    public class TestCenter
    {
        ...
        public static void GiveArtifacts(Mobile from)
        {
            ...
            for (int i = 0; i < DoomGauntlet.DoomArtifact.Length; i++)
            {
                bag.DropItem(Loot.Construct(DoomGauntlet.DoomArtifact[i]));
            }
        ...
        public static void FillBank(Mobile m)
        {
            ...
            PlaceItemIn(bag, 93, 82, new EmptyBottle(1000));
        ...
        public class TCHelpGump : Gump
        {
            ...
            public override void OnResponse(NetState sender, RelayInfo info)
            {
                switch (info.ButtonID)
                {
                    case 1:
                        {
                            sender.LaunchBrowser("https://servuox.com");
                            break;
                        }
